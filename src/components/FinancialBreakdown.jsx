import React from 'react';
    ...
    const getTransactionTypeBadge = (type) => {
        switch (type) {
            ...
            case 'commission_payment': return <Badge className="bg-purple-100 text-purple-800 flex items-center text-xs"><Coins className="h-3 w-3 mr-1"/>Commission</Badge>;
            case 'case_payment': return <Badge className="bg-indigo-100 text-indigo-800 flex items-center text-xs"><Coins className="h-3 w-3 mr-1"/>Case Payment</Badge>;
