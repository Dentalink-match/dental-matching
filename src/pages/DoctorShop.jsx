...
const DoctorShop = () => {
  ...
  const { doctorProducts, loading, cart, addToCart, handleCheckout } = useEcommerce();

  return (
    <>
      <Helmet>
        <title>Doctor's Shop - DentaLink</title>
        <meta name="description" content="Exclusive products for doctors." />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-4">
                ...
                <h1 className="text-xl md:text-2xl font-bold text-gradient">Doctor's Shop</h1>
              </div>
